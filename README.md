# Домашнее задание "Организация сети" - `Фомичев Анатолий`

## Ссылка на Д3 - https://github.com/netology-code/clopro-homeworks/blob/main/15.1.md
  
  
### Задача 1

#### Файлы Terraform
https://github.com/SLzDevOps/neto-teraform15-1/tree/main
